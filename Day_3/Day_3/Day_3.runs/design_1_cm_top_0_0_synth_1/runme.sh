...
HD_PWD='D:/IEP/Day_3_IEP/Day_3/Day_3.runs/design_1_cm_top_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_cm_top_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_cm_top_0_0.tcl
