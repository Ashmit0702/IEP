...
HD_PWD='D:/IEP/Day_1_1024/Day_1_1024.runs/design_1_xfft_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_xfft_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_xfft_0_1.tcl
