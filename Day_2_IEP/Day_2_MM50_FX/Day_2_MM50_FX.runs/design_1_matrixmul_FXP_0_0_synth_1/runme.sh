...
HD_PWD='D:/IEP/Day_2_MM50_FX/Day_2_MM50_FX.runs/design_1_matrixmul_FXP_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_matrixmul_FXP_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_matrixmul_FXP_0_0.tcl
