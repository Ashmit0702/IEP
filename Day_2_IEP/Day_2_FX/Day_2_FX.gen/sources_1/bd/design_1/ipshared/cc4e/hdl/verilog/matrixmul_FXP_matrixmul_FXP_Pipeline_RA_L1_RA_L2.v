...
wire   [53:0] man_V_4_fu_238_p3;
reg   [53:0] man_V_4_reg_545;
reg   [53:0] man_V_4_reg_545_pp0_iter3_reg;
...
wire   [8:0] add_ln83_1_fu_415_p2;
reg   [8:0] add_ln83_1_reg_588;
wire   [23:0] select_ln606_fu_461_p3;
reg   [23:0] select_ln606_reg_593;
wire   [63:0] zext_ln83_2_fu_484_p1;
reg   [4:0] col_fu_98;
...
wire   [52:0] p_Result_11_fu_221_p3;
wire   [53:0] zext_ln604_fu_228_p1;
wire   [53:0] man_V_3_fu_232_p2;
...
wire   [0:0] icmp_ln80_fu_363_p2;
wire   [4:0] add_ln78_fu_357_p2;
wire   [6:0] tmp_2_fu_393_p3;
wire   [8:0] tmp_1_fu_385_p3;
wire   [8:0] zext_ln83_fu_401_p1;
wire   [4:0] select_ln78_fu_369_p3;
wire   [8:0] add_ln83_fu_405_p2;
wire   [8:0] zext_ln83_1_fu_411_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln78_fu_156_p2 == 1'd0) & (ap_start_int == 1'b1))) begin
            indvar_flatten_fu_106 <= add_ln78_1_fu_162_p2;
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
            ...
            row_fu_102 <= select_ln78_1_fu_377_p3;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        add_ln83_1_reg_588 <= add_ln83_1_fu_415_p2;
        ...
        man_V_4_reg_545_pp0_iter3_reg <= man_V_4_reg_545;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln606_reg_538 == 1'd0))) begin
        ...
        man_V_4_reg_545 <= man_V_4_fu_238_p3;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln78_fu_156_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln78_fu_156_p2 == 1'd1) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (icmp_ln78_fu_156_p2 == 1'd0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln78_fu_156_p2 == 1'd0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        in_AB_TREADY = 1'b1;
    end else begin
        in_AB_TREADY = 1'b0;
    end
...
assign add_ln78_1_fu_162_p2 = (ap_sig_allocacmp_indvar_flatten_load + 9'd1);

assign add_ln78_fu_357_p2 = (row_fu_102 + 5'd1);

assign add_ln80_fu_468_p2 = (select_ln78_fu_369_p3 + 5'd1);

assign add_ln83_1_fu_415_p2 = (add_ln83_fu_405_p2 + zext_ln83_1_fu_411_p1);

assign add_ln83_fu_405_p2 = (tmp_1_fu_385_p3 + zext_ln83_fu_401_p1);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((icmp_ln78_fu_156_p2 == 1'd0) & (in_AB_TVALID == 1'b0) & (ap_start_int == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((icmp_ln78_fu_156_p2 == 1'd0) & (in_AB_TVALID == 1'b0) & (ap_start_int == 1'b1));
end

always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((icmp_ln78_fu_156_p2 == 1'd0) & (in_AB_TVALID == 1'b0));
end
...
assign ashr_ln621_fu_424_p2 = $signed(man_V_4_reg_545_pp0_iter3_reg) >>> zext_ln621_fu_421_p1;

assign grp_fu_108_p_ce = grp_fu_135_ce;

assign grp_fu_108_p_din0 = tmp_5_fu_172_p1;
...
assign icmp_ln78_fu_156_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 9'd400) ? 1'b1 : 1'b0);

assign icmp_ln80_fu_363_p2 = ((col_fu_98 == 5'd20) ? 1'b1 : 1'b0);

assign input_A_V_address0 = zext_ln83_2_fu_484_p1;

assign input_A_V_d0 = select_ln606_reg_593;

assign ireg_fu_182_p1 = grp_fu_108_p_dout0;

assign man_V_3_fu_232_p2 = (54'd0 - zext_ln604_fu_228_p1);

assign man_V_4_fu_238_p3 = ((p_Result_s_reg_523[0:0] == 1'b1) ? man_V_3_fu_232_p2 : zext_ln604_fu_228_p1);

assign or_ln617_fu_287_p2 = (icmp_ln617_fu_277_p2 | icmp_ln606_reg_538);

assign p_Result_11_fu_221_p3 = {{1'd1}, {trunc_ln600_reg_533}};
...
assign select_ln78_1_fu_377_p3 = ((icmp_ln80_fu_363_p2[0:0] == 1'b1) ? add_ln78_fu_357_p2 : row_fu_102);

assign select_ln78_fu_369_p3 = ((icmp_ln80_fu_363_p2[0:0] == 1'b1) ? 5'd0 : col_fu_98);
...
assign tmp_1_fu_385_p3 = {{select_ln78_1_fu_377_p3}, {4'd0}};

assign tmp_2_fu_393_p3 = {{select_ln78_1_fu_377_p3}, {2'd0}};

assign tmp_5_fu_172_p1 = in_AB_TDATA;
...
assign trunc_ln618_fu_283_p1 = man_V_4_fu_238_p3[23:0];
...
assign zext_ln604_fu_228_p1 = p_Result_11_fu_221_p3;

assign zext_ln621_fu_421_p1 = $unsigned(sext_ln616_reg_573);

assign zext_ln83_1_fu_411_p1 = select_ln78_fu_369_p3;

assign zext_ln83_2_fu_484_p1 = add_ln83_1_reg_588;

assign zext_ln83_fu_401_p1 = tmp_2_fu_393_p3;
