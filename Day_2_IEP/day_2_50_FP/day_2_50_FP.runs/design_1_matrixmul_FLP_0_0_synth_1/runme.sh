...
HD_PWD='D:/IEP/day_2_50_FP/day_2_50_FP.runs/design_1_matrixmul_FLP_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_matrixmul_FLP_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_matrixmul_FLP_0_0.tcl
